...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference('Following.count') do
      post followings_url, params: { following: { created_at: @following.created_at, followed_id: @following.followed_id, follower_id: @following.follower_id } }, as: :json
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { created_at: @following.created_at, followed_id: @following.followed_id, follower_id: @following.follower_id } }, as: :json
    assert_response 200
  end
